...
public class MyStudent_Details extends JFrame {
	...
	public static void main(String[] args) {
		...
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					MyStudent_Details frame = new MyStudent_Details();
	 ...
	 * Create the frame.
	 */
	public MyStudent_Details() {
		
		connection=Mysql.dbConnector();
		
		setBackground(new Color(112, 128, 144));
		setTitle("My Student Profile");
...
/*				textFieldStatus.setForeground(new Color(255, 255, 255));
		...
		button.setBounds(258, 296, 158, 47);
		panel_1.add(button);
		...
		button_1.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				try 
				{
					...
					sCtrl.UpdateProjectForMyStudent(project);
...
/*				textFieldStatus.setForeground(new Color(0, 0, 0));
		...
		button_1.setBounds(455, 296, 158, 47);
		panel_1.add(button_1);
		
		comboBoxStatus = new JComboBox();
		comboBoxStatus.setEnabled(false);
		comboBoxStatus.setForeground(new Color(0, 0, 0));
		comboBoxStatus.setBackground(new Color(245, 245, 245));
		comboBoxStatus.setFont(new Font("Arial Narrow", Font.PLAIN, 20));
		comboBoxStatus.setModel(new DefaultComboBoxModel(new String[] {"Approve", "Not Approve"}));
...
public void actionPerformed(ActionEvent arg0) {
		...
		btnNewButton.setBounds(216, 138, 117, 32);
		...
		button_4.setBounds(645, 138, 117, 32);
		panel_2.add(button_4);
		
		JLabel label_8 = new JLabel("File Submission:");
		label_8.setForeground(Color.BLACK);
		label_8.setFont(new Font("Arial Narrow", Font.BOLD, 20));
		label_8.setBounds(507, 138, 154, 34);
		panel_2.add(label_8);
		
		JLabel label_9 = new JLabel("Time Upload:");
		label_9.setForeground(Color.BLACK);
		label_9.setFont(new Font("Arial Narrow", Font.BOLD, 20));
		label_9.setBounds(507, 91, 109, 34);
		panel_2.add(label_9);
		
		lblTime2 = new JLabel("Real TIme");
		lblTime2.setForeground(Color.BLACK);
		lblTime2.setFont(new Font("Arial Narrow", Font.PLAIN, 20));
		lblTime2.setBounds(616, 91, 188, 34);
		panel_2.add(lblTime2);
		
		JLabel lblAnalysis = new JLabel("ANALYSIS");
		lblAnalysis.setForeground(Color.GRAY);
		lblAnalysis.setFont(new Font("Arial Narrow", Font.BOLD, 30));
		lblAnalysis.setBackground(Color.GRAY);
		lblAnalysis.setBounds(507, 13, 145, 65);
		panel_2.add(lblAnalysis);
		
		JLabel label_10 = new JLabel("File Submission:");
		label_10.setForeground(Color.BLACK);
		label_10.setFont(new Font("Arial Narrow", Font.BOLD, 20));
		label_10.setBounds(78, 359, 154, 34);
		...
		button_5.setBounds(216, 359, 117, 32);
		panel_2.add(button_5);
		
		JLabel label_11 = new JLabel("Time Upload:");
		label_11.setForeground(Color.BLACK);
		label_11.setFont(new Font("Arial Narrow", Font.BOLD, 20));
		label_11.setBounds(78, 312, 109, 34);
		panel_2.add(label_11);
		
		lblTime3 = new JLabel("Real TIme");
		lblTime3.setForeground(Color.BLACK);
		lblTime3.setFont(new Font("Arial Narrow", Font.PLAIN, 20));
		lblTime3.setBounds(187, 312, 188, 34);
		panel_2.add(lblTime3);
		
		JLabel lblDesign = new JLabel("DESIGN");
		lblDesign.setForeground(Color.GRAY);
		lblDesign.setFont(new Font("Arial Narrow", Font.BOLD, 30));
		lblDesign.setBackground(Color.GRAY);
		lblDesign.setBounds(78, 234, 145, 65);
		panel_2.add(lblDesign);
		...
		button_2.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				...
				MyStudent_Search1 studsearch = new MyStudent_Search1();
				studsearch.lblID.setText(user);
		...
		lblID = new JLabel("");
		lblID.setBounds(0, 0, 97, 34);
		contentPane.add(lblID);
		lblID.setForeground(Color.BLACK);
		lblID.setFont(new Font("Arial Narrow", Font.BOLD, 20));
	...
	public void updateDataStudent_Registered() 
	{
		...
		try 
		{
			...
			sCtrl.updateMyStudent_Details(student);
	...
	public void uploadLoad() 
	{
		...
		{
			studentController sCtrl = new studentController();
			sCtrl.updateMyStudentProfile_Details(student);
	...
	{
		//String query="Select * from Student_Registered,Project,Document where Student_Registered.SID='"+a1+"' = Project.SID='"+a1+"' = Document.SID='"+a1+"' ";
		String a1= textFieldID.getText();
