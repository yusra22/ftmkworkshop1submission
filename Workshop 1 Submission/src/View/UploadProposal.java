...
public class UploadProposal extends JFrame {
	...
	EventQueue.invokeLater(new Runnable() {
			...
			public void run() {
				try {
					UploadProposal frame = new UploadProposal();
	...
	public void refreshSelect() 
	{
		...
		try 
		{
			...
			if(rs.next())
			{
				...
				lblTime.setText(rs.getString(4));
				rs.close();
				pst.close();
			}
			else 
